...
public class Rom {
    ...
    public int getKapasitet_und() {
        return kapasitet_und;
    }

    public void setKapasitet_und(int kapasitet_und) {
        this.kapasitet_und = kapasitet_und;
    }
    ...
    public String getRom_navn() {
        return rom_navn;
    }

    public void setRom_navn(String rom_navn) {
        this.rom_navn = rom_navn;
    }
