...
public class RequestData {
    ...
    */
    ...
    public void getRoom(String sessionKey, String epost, Context context) {
        String urlString = "/getRoom.php?sessionkey=" + sessionKey + "&epost=" + epost;
        ContextUrl contextUrl = new ContextUrl(context, urlString);
        GetRoomAsyncTask getroom = new GetRoomAsyncTask();
        getroom.execute(contextUrl);
    }

    public void getAvailableRooms(String sessionKey, String epost, String fra,
    ...
    public void getReservation(String sessionKey, String epost, int reservasjonsId, Context context) {
        String urlString = "/getReservation.php?sessionkey=" + sessionKey + "&epost=" + epost
    ...
    public void getUser(String sessionKey, String epost, Context context) {
        String urlString = "/getUser.php?sessionkey=" + sessionKey + "&epost=" + epost;
        ContextUrl contextUrl = new ContextUrl(context, urlString);
        GetUserAsyncTask getUser = new GetUserAsyncTask();
        getUser.execute(contextUrl);
    }

    public void addReservation(String sessionKey, String epost, String fra, String til,
                               String romkode, int gruppekode, String gruppeleder, String formal, Context context) {
        String urlString = "/addReservation.php?sessionkey=" + sessionKey + "&epost=" + epost
    ...
    public void editReservation(String sessionKey, String epost, String fra, String til,
                                String formal, String reservasjonsId, Context context) {
        String urlString = "/editReservation.php?sessionkey=" + sessionKey + "&epost=" + epost
